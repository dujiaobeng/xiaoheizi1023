...
function Library:Window(name, game, preset, closebind)
    ...
    Main.Visible = true
    Main.Image = "rbxassetid://15487864725"--这里填你的背景图ID(要roblox的图片ID)
    ...
    function tabhold:Tab(text)
        ...
        function tabcontent:Toggle(text,default, callback)
            ...
            FrameToggle1.BackgroundColor3 = Color3.fromRGB(100, 100, 100)
            ...
            FrameToggle2.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
            ...
            FrameToggleCircle.BackgroundColor3 = Color3.fromRGB(100, 100, 100)
