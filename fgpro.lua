...
local Window = OrionLib:MakeWindow({Name = "杜脚本", HidePremium = false, SaveConfig = true,ConfigFolder = "dujiaobeng"})
...
local Section = Tab:AddSection({	Name = "功能"})Tab:AddButton({	Name = "飞行",	Callback = function()
